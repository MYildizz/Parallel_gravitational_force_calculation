...
void calculate_gravitational_force(int Count ,int *stars,double gravitational_force_list[]);
double calculate_distance(int *stars,int main_star_index,int other_star_index);
void calculate_2Norm(int Count,double gravitational_force_list[]);
...
int main(int argc, char* argv[]){
    ...
    calculate_gravitational_force(Star_count ,stars,gravitational_force_list);

    //Calculate 2 Norm
    calculate_2Norm(Star_count,gravitational_force_list);
